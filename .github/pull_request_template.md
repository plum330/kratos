...
1. If this is your first time contributing to Kratos, please read our contribution guide: https://plum330.dev/en/docs/community/contribution/
...
4. Please use a semantic commits format title, such as `<type>[optional scope]: <description>`, see: https://plum330.dev/docs/community/contribution#type
...
如果这是你第一次为 Kratos 贡献，请阅读我们的贡献指南：https://plum330.dev/en/docs/community/contribution/
...
4、请使用语义提交格式标题，如“<类型>[可选范围]：<说明>`，请参阅：https://plum330.dev/docs/community/contribution#type
