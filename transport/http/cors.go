...
func CORS(opts ...Option) FilterFunc {
	return func(handler http.Handler) http.Handler {
		options := cors.Options{
			...
			AllowedHeaders:   []string{"Origin", "Content-Length", "Content-Type", "Accept-Encoding", "Authorization", "X-CSRF-Token", "Content-Disposition"},
