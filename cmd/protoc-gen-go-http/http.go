...
const (
	...
	transportHTTPPackage = protogen.GoImportPath("github.com/plum330/kratos/v2/transport/http")
	bindingPackage       = protogen.GoImportPath("github.com/plum330/kratos/v2/transport/http/binding")
)
