...
func KratosMod() string {
	...
	if path, err := ModuleVersion("github.com/plum330/kratos/v2"); err == nil {
		// $GOPATH/pkg/mod/github.com/plum330/kratos@v2
		return filepath.Join(cachePath, path)
	}
	// $GOPATH/src/github.com/plum330/kratos
	return filepath.Join(gopath, "src", "github.com", "plum330", "kratos")
}
